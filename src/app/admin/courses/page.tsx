    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center space-x-4">
          <Link href="/admin/dashboard" className="p-2.5 rounded-xl bg-udemy-black border border-slate-800 text-slate-300 hover:text-white hover:border-udemy-purple/30">
        ...
        <button
          ...
          className="gold-button px-5 py-3 rounded-xl font-bold text-xs flex items-center space-x-2 shadow-lg shadow-udemy-purple/20"
        >
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
          <div className="glass-panel max-w-2xl w-full p-8 rounded-3xl border border-udemy-purple/30 shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-xl bg-udemy-purple/10 border border-udemy-purple/30 flex items-center justify-center">
            ...
            <form onSubmit={handleCreateCourse} className="space-y-4 text-xs">
              ...
              {/* Pricing & Duration */}
              <div className="grid grid-cols-4 gap-3 p-3 rounded-2xl bg-udemy-black/60 border border-slate-800">
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-2 py-1.5 rounded-lg bg-slate-950 border border-slate-800 text-white font-mono text-udemy-purple"
                  />
                </div>
                <div>
              ...
              <div className="p-4 rounded-2xl bg-udemy-purple/5 border border-udemy-purple/20 space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl bg-slate-950 border border-slate-800 text-white font-mono focus:border-udemy-purple focus:outline-none"
              ...
              <div className="flex items-center justify-end space-x-3 pt-4">
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl bg-udemy-black text-slate-300 hover:text-white font-bold"
                >
                  Cancel
                </button>
                <button
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs text-slate-300">
            ...
            <tbody className="divide-y divide-slate-800">
              {courses.map((course) => (
                <tr key={course.id} className="hover:bg-udemy-black/50">
                  ...
                  <td className="p-3">
                    <Link
                      ...
                      className="px-3 py-1.5 rounded-lg bg-slate-800 text-udemy-purple hover:bg-slate-700 font-semibold text-[11px]"
                    >
                      View Details
                    </Link>
                  </td>
