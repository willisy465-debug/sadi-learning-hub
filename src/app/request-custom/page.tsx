    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="text-3xl sm:text-5xl font-black text-udemy-black tracking-tight">
        ...
        {submitted ? (
          <div className="bg-white p-10 rounded-3xl border border-emerald-500/30 text-center space-y-4 shadow-sm">
            <div className="w-14 h-14 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center mx-auto border border-emerald-200">
              <CheckCircle className="w-8 h-8" />
            </div>
            <h3 className="text-2xl font-bold text-udemy-black">Custom Request Received!</h3>
          ...
          <div className="bg-white p-8 sm:p-10 rounded-3xl border border-udemy-grayBorder shadow-lg">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs font-bold text-udemy-black mb-1.5">Organisation / Institution Name</label>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full px-4 py-2.5 rounded-xl bg-udemy-gray border border-udemy-grayBorder text-black text-sm focus:border-udemy-purple focus:outline-none"
                  />
                </div>

                <div>
                  <label className="block text-xs font-bold text-udemy-black mb-1.5">Contact Person & Title</label>
                  <input
                    type="text"
                    required
              ...
              <div>
                <label className="block text-xs font-bold text-udemy-black mb-1.5">Official Email Address</label>
                <input
                  type="email"
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-udemy-black mb-1.5">Phone / WhatsApp Number</label>
                <input
                  type="tel"
                  required
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div>
                <label className="block text-xs font-bold text-udemy-black mb-1.5">Country</label>
                <select
              ...
              <div>
                <label className="block text-xs font-bold text-udemy-black mb-1.5">Estimated Delegates</label>
                <input
                  type="number"
                  min={1}
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-udemy-black mb-1.5">Preferred Delivery Mode</label>
                <select
            ...
            <div>
              <label className="block text-xs font-bold text-udemy-black mb-1.5">Preferred Course Title or Scope</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-xs font-bold text-udemy-black mb-1.5">Additional Requirements / Preferred Dates</label>
              <textarea
                rows={4}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full gold-button py-3.5 rounded-xl font-bold text-sm flex items-center justify-center space-x-2 shadow-lg shadow-udemy-purple/20 text-white"
            >
